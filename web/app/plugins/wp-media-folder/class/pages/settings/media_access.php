        ...
        <div class="content-box content-wpmf-media-access">
            <div class="ju-settings-option">
                <div class="wpmf_row_full">
                    ...
                    <label data-alt="<?php esc_html_e('When enabling this option you will have the possibility to transform media file links (like .pdf, .doc... into a nice download button. Setup the button design below', 'wpmf'); ?>"
