    ...
    <div class="content-box content-wpmf-general">
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                ...
                <label data-alt="<?php esc_html_e('Enable or not the display of folders in the main view on top of the media', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                ...
                <label data-alt="<?php esc_html_e('Display the number of media
             available in root folder, in the folder tree', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option">
            <div class="wpmf_row_full">
                ...
                <label data-alt="<?php esc_html_e('If enabled, when you search file in a folder, it will search in its subfolders too', 'wpmf'); ?>"
        ...
        <div class="ju-settings-option wpmf_right m-r-0">
            <div class="wpmf_row_full">
                ...
                <label data-alt="<?php esc_html_e('Right click on an image or file in the media manager to download it. Image original sized will be downloaded', 'wpmf'); ?>"
